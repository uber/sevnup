 ...
 *    another node.
 */
function VNodeStore(loadVNodeKeysFromStorage, persistKeyToVNode, persistRemoveKeyFromVNode, recoverKey, releaseKey) {
    this.vnCache = {};
...
VNodeStore.prototype.onKeysLoaded = function onKeysLoaded(err, vnodeName, keys, done) {
    ...
    if (typeof self.recoverKey === 'function') {
       async.eachLimit(nodeKeyArray, MAX_PARALLEL_TASKS,
